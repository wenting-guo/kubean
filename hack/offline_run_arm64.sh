...
function case::create_kylin_cluster(){
  ...
  util::init_kylin_vm ${template_name1} ${vm_name1} ${ARM64_SERVER_IP} ${ARM_SERVER_PASSWORD}
  util::init_kylin_vm ${template_name2} ${vm_name2} ${ARM64_SERVER_IP} ${ARM_SERVER_PASSWORD}
  ...
  #### tear down ####
  util::delete_kylin_vm ${vm_name1} ${ARM64_SERVER_IP} ${ARM_SERVER_PASSWORD}
  util::delete_kylin_vm ${vm_name2} ${ARM64_SERVER_IP} ${ARM_SERVER_PASSWORD}
  echo "Delete vm end!"
}
